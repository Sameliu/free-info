 ...
 */
public class GoldRunToHomeForxiaoli {
    public static void main(String[] args) {
        String str = null;
        String path = "/Users/sijinzhang/codeStudy/study/free-info/src/main/resources/golds/xiaoli.txt";
        ...
        try {
            ...
            while((str = br.readLine()) != null) {
                str = str.trim();
                tmp  = str.startsWith("6") ? "sh" + str : "sz" + str;
                codes.add(tmp);
            }
            html(codes);
        }catch (Exception e){
    ...
    private static void html(List<String> codes) throws FileNotFoundException {
        File f = new File("/Users/sijinzhang/codeStudy/study/free-info/src/main/resources/golds/xiaoli.html");
