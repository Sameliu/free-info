...
public class HtmlUtil {
    ...
    public static void generateSimpleHtml(List<DockMA> list,String fileName){
        File f = new File(dir+ fileName);
        htmlSimple(list, f);
    }

    private static void htmlSimple(List<DockMA> list, File f) {
        try {
            start(f);
            contentSimple(list);
            end();
    ...
    private static void contentSimple(List<DockMA> list) {
        ...
        for(int i =0;i<list.size();i++){
            ...
            sb.append("</td>");
            sb.append("<td>");
            sb.append("<img src =\"http://image.sinajs.cn/newchart/weekly/n/"+list.get(i).getCode()+".gif\"");
            sb.append("</td>");
    ...
    private static void content(List<DockMA> list) {
        ...
        sb.append("<tr>");
        sb.append("<th>序号</th>");
        sb.append("<th width='90px' align='center'>操作</th>").append("<th>MA5<br/>R5</th>").append("<th>MA10<br/>R10</th>");
        ...
        sb.append("<th>k线图日线</th>").append("<th>k线图周线</th>");
        sb.append("</tr>");
        for(int i =0;i<list.size();i++){
            sb.append("<tr>");
            sb.append("<td>" + (i + 1) + "<br />").append(list.get(i).getName()).append("</td>");
            sb.append("<td align='center'>");
            sb.append("<a target=\"_blank\" href=\"http://f10.eastmoney.com/f10_v2/CompanyManagement.aspx?code="+list.get(i).getCode()+"\">高管</a><br/><br/>");
            sb.append("<a target=\"_blank\" href=\"http://f10.eastmoney.com/f10_v2/FinanceAnalysis.aspx?code="+list.get(i).getCode()+"\">财报</a><br/><br/>");
            sb.append("<a target=\"_blank\" href=\"http://f10.eastmoney.com/f10_v2/OperationsRequired.aspx?code="+list.get(i).getCode()+"\">必读</a><br/><br/>");
            ...
            sb.append("<td><img src =\"http://image.sinajs.cn/newchart/daily/n/" + list.get(i).getCode()+".gif\"</td>");
            sb.append("<td><img src =\"http://image.sinajs.cn/newchart/weekly/n/"+list.get(i).getCode()+".gif\"</td>");
            sb.append("</tr>");
        }
        sb.append("</table>");
    }
    ...
    private static String dockTd(DockMA dockMA) {
        ...
        b.append("<td>").append(df.format(dockMA.getDeviation())).append("(最低价偏离当前价)").append("<br />----<br />").append(df.format((dockMA.getHighPirce() - dockMA.getPrice()) / dockMA.getPrice())).append("(最高价偏离当前价)").append("</td>");
        return b.toString();
    }
